  ...
  habits: {
    ...
    app: {
      ...
      dashboard: {
        ...
        replace: "Заменить",
        softStepSaved: "Выбран облегченный вариант. Его можно отметить как шаг дня.",
        saveStep: "Сохранить мягкий шаг",
        personalize: "Обновить по отчету без сброса",
        metricTitle: "Метрика дня",
        metricCopy: "Это не обязанность, а быстрый снимок состояния.",
      ...
      guide: {
        title: "Гид",
        copy: "Программа устроена как мягкий годовой маршрут, а не как список обязательств.",
        blocks: [
          "Каждая неделя открывает одну привычку: суть, практику, зачем это нужно и место для инсайта.",
          "7 отметок помогают закрыть неделю, но можно перейти мягко или использовать freeze, если жизнь требует паузы.",
