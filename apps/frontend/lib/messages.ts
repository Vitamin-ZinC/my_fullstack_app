    ...
    app: {
      ...
      habitsUx: {
        ...
        tooltips: {
          ...
          calendar: "Создает событие в Google Calendar для текущей привычки.",
        ...
        actionHelp: {
          ...
          calendar: "«Календарь» — напоминание на 15 минут по текущей практике."
        },
        metricScales: {
          energy: [
