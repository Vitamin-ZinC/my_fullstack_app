  ...
  habits: {
    ...
    app: {
      ...
      dashboard: {
        ...
        softStepHelp: "«Сделать проще» только подставляет самую маленькую версию действия в заметку. Выполнение засчитывается отдельной кнопкой отметки.",
        ...
        metricRewardHelp: "Первая сохраненная метрика дня дает +5 XP. Повторное сохранение обновляет данные без повторного начисления.",
      ...
      journey: {
        ...
        todayAvailable: "Сегодня доступно до +15 XP",
      ...
      habitsUx: {
        ...
        weekControlsTitle: "Переход недели",
        journeySteps: {
        ...
        tooltips: {
          ...
          saveMetric: "Сохраняет состояние. Первая запись метрик за день дает +5 XP.",
          saveInsight: "Сохраняет вывод в архив и передает его Пингви как часть твоей истории.",
          advance: "Открывает следующую неделю после 7 отметок текущей недели.",
          softAdvance: "Мягко открывает следующую неделю даже без 7 отметок. XP меньше, зато путь не стопорится.",
          freeze: "Пауза на неделю, если нужен отдых. Freeze не считается провалом.",
        ...
        actionHelp: {
          ...
          advance: "«Перейти дальше» — обычное закрытие недели после 7 отметок.",
          softAdvance: "«Мягкий переход» — если неделя была сложной, но ты хочешь продолжить без ощущения провала.",
          freeze: "«Freeze» — пауза без ощущения долга. Используй, когда ресурс ниже нормы.",
      ...
      messages: {
        ...
        taskVariantSaved: "Другой шаг выбран. Текст сегодняшней привычки обновился.",
