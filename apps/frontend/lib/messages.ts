...
export const ruSiteText = {
  ...
  habits: {
    ...
    app: {
      ...
      dashboard: {
        eyebrow: "Сохраненная программа",
        title: "Сегодня",
        topbarCopy: "маленькие действия, метрики и инсайты без обязательного марафона",
        todayFocus: "Сегодняшний фокус",
        firstStep: "Первый шаг сегодня",
        done: "Сделал",
        tooMuch: "Сделать проще",
        replace: "Заменить",
        softStepSaved: "Облегченный вариант подставлен в заметку. Нажми «Отметить шаг дня», когда сделаешь его.",
        softStepHelp: "Если задача кажется слишком большой, кнопка не засчитывает выполнение. Она предлагает минимальную версию, которую можно сделать без давления.",
        ...
        metricTitle: "Метрика дня",
        metricCopy: "Это не обязанность, а быстрый снимок состояния. Оценка помогает видеть динамику, но не влияет на доступ к привычкам.",
        ...
        progressTitle: "Видимый прогресс",
        ...
        xpRules: [
          ...
          "+5 XP — первая сохраненная метрика состояния за день.",
          "+15 XP — сохраненный инсайт в архив.",
          "+35 XP — завершение недели после 7 отметок.",
          "+10 XP — мягкий переход к следующей неделе без 7 отметок.",
          "+5 XP — freeze недели, когда нужна пауза без потери ритма."
        ],
      ...
      journey: {
        title: "Мой путь",
        copy: "4 цикла по 12 недель. Неделя меняется вручную, когда ты готов двигаться дальше.",
        essence: "Суть",
        practice: "Практика",
        why: "Зачем",
        weekCalendar: "Неделя в отметках",
        advance: "Перейти дальше",
        softAdvance: "Перейти мягко сейчас",
        freeze: "Заморозить неделю",
        noFreezes: "Freeze закончились",
        calendar: "Добавить в Google Calendar",
      ...
      habitsScreen: {
        title: "Все привычки",
        copy: "48 недель программы. Можно смотреть весь путь, фильтровать циклы и отмечать текущий шаг.",
        allCycles: "Все циклы",
        quickMark: "Отметить",
        expand: "Подробнее",
        collapse: "Свернуть"
      ...
      archive: {
        ...
        empty: "Пока нет сохраненных инсайтов.",
      ...
      guide: {
        title: "Гид",
        copy: "Программа устроена как мягкий годовой маршрут, а не как список обязательств. Ниже — пошаговая инструкция, как пользоваться кабинетом без давления.",
        blocks: [
          ...
          "Выбери шаг дня. Если базовая практика кажется большой, нажми «Сделать проще» — кабинет предложит минимальную версию.",
          "Когда шаг реально сделан, нажми «Отметить шаг дня». Тогда отметка попадет в неделю, а первая отметка дня даст XP.",
          "Если появилась мысль или вывод, сохрани инсайт. Он попадет в архив и будет доступен Пингви.",
          "Когда на неделе 7 отметок, можно перейти дальше. Если неделя была сложной, используй мягкий переход или freeze.",
      ...
      settings: {
        title: "Настройки",
        copy: "Профиль, reminder, trial и подписка берутся из backend, а не из локального HTML.",
        profile: "Профиль",
        name: "Имя",
        avatar: "Аватар",
        weakZone: "Фокус Икигай",
        reminders: "Напоминания",
        reminderEnabled: "Включить reminder",
        reminderTime: "Время",
        subscription: "Trial и подписка",
        trialLeft: "Дней trial осталось",
        price: "Стоимость после trial",
      ...
      messages: {
        ...
        metricSaved: "Метрика дня сохранена",
        checkinSaved: "Шаг отмечен, награда добавлена",
      ...
      errors: {
        ...
        server: "Сервер кабинета временно недоступен. Проверьте, что backend запущен."
      }
    }
  }
} as const;
