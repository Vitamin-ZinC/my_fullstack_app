  ...
  habits: {
    ...
    app: {
      ...
      dashboard: {
        ...
        tooMuch: "Мини-шаг",
        replace: "Другой вариант",
        softStepSaved: "Мини-шаг подставлен в заметку. Когда сделаешь его, нажми «Отметить шаг дня».",
        softStepHelp: "«Мини-шаг» только подставляет самую маленькую версию действия в заметку. Выполнение засчитывается отдельной кнопкой отметки.",
      ...
      habitsUx: {
        ...
        tooltips: {
          dashboard: "Главный экран: фокус дня, шкалы состояния, XP и быстрые действия.",
          journey: "Путь показывает текущую неделю, переход дальше, freeze и календарь.",
          ...
          tooMuch: "Подставляет самый маленький вариант действия в заметку. XP начисляется только после отметки выполнения.",
        ...
        actionHelp: {
          ...
          softAdvance: "«Мягкий переход» — если неделя была сложной, но ты хочешь продолжить.",
